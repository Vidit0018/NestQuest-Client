...
const UpdateListing = () => {
  ...
  useEffect(() => {
    const fetchListing = async () => {
      ...
      const res = await fetch(
        `https://nestquest-server-1.onrender.com/api/listing/get/${listingId}`,
        {
          method: "GET",
          credentials: "include",
        }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(false);
      const res = await fetch(
        `https://nestquest-server-1.onrender.com/api/listing/update/${params.listingId}`,
        {
          method: "POST",
          headers: {
  ...
  return (
    <main className="p-3 max-w-4xl mx-auto ">
      ...
      <form
        ...
        className="flex flex-col sm:flex-row font-semibold text-lime-800 gap-4"
      >

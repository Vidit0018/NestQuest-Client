...
export default function Home() {
  ...
  useEffect(() => {
    const fetchOfferListings = async () => {
      try {
        const res = await fetch('https://nestquest-server-1.onrender.com/api/listing/get?offer=true&limit=4');
    ...
    const fetchRentListings = async () => {
      try {
        const res = await fetch('https://nestquest-server-1.onrender.com/api/listing/get?type=rent&limit=4');
        const data = await res.json();
    ...
    const fetchSaleListings = async () => {
      try {
        const res = await fetch('https://nestquest-server-1.onrender.com/api/listing/get?type=sale&limit=4');
        const data = await res.json();
